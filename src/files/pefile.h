...
public:
    ...
    struct OptionalHeader
    {
        ...
        uint64_t imageBase; // 32 bit for PE32, 64 for PE32+
        ...
        uint64_t sizeOfStackReserve; // 32 bit for PE32, 64 for PE32+
    ...
    enum CoffCharacteristics
    {
        ...
        CCHAR_LARGE_ADDRESS_AWARE = 0x0020, // Application can handle > 2-GB addresses
        ...
        CCHAR_SYSTEM = 0x1000,
        CCHAR_DLL = 0x2000,
        CCHAR_UP_SYSTEM_ONLY = 0x4000, // should only be run on a uniprocessor machine

...
int PECoffModel::columnCount(const QModelIndex &parent) const { return 1; }
  ...
  case Qt::DisplayRole:
    ...
    case 0:
      return QStringLiteral("0x%1 (%2)")
          ...
          .arg(CoffFile::machineString(
              static_cast<CoffFile::MachineType>(peFile_->coffHeader_.machine)));
    case 1:
    ...
    case 6:
      return QStringLiteral("0x%1 (%2)")
          ...
          .arg(CoffFile::coffCharString(static_cast<CoffFile::CoffCharacteristics>(
...
int PEOptionalModel::columnCount(const QModelIndex &parent) const { return 1; }
  ...
  case Qt::DisplayRole:
    ...
    case 0: { // signature
      QString s =
          QStringLiteral("0x%1 (%2)")
              .arg(QString::number(peFile_->optionalHeader_.signature, 16));
    ...
    case 6: // addressOfEntryPoint
      return QStringLiteral("0x%1").arg(
          QString::number(peFile_->optionalHeader_.addressOfEntryPoint, 16));
    case 7: // baseOfCode
      return QStringLiteral("0x%1").arg(
    ...
    case 23: // dllCharacteristics
      return QStringLiteral("0x%1 (%2)")
          .arg(QString::number(peFile_->optionalHeader_.dllCharacteristics, 16))
          .arg(CoffFile::dllCharString(static_cast<CoffFile::DllCharacteristics>(

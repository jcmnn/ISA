    ...
    ui_(new Ui::PEInfoWidget)
{
    ...
    connect(&coffModel_, &PECoffModel::dataChanged, this, &PEInfoWidget::resizeCoff);
    connect(&optionalModel_, &PEOptionalModel::dataChanged, this, &PEInfoWidget::resizeOptional);
    connect(&sectionModel_, &PESectionModel::dataChanged, this, &PEInfoWidget::resizeSection);
